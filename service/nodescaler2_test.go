...
func TestNodeScalerNewUnitTest(t *testing.T) {
	suite.Run(t, new(NodeScalerNewTestSuite))
}

func (s *NodeScalerNewTestSuite) SetupTest() {
...
func (s *NodeScalerNewTestSuite) TearDownTest() {
	s.inspectorMock.AssertExpectations(s.T())
	s.cloudProviderMock.AssertExpectations(s.T())
}

func (s *NodeScalerNewTestSuite) getNodeService() swarm.Service {
...
func (s *NodeScalerNewTestSuite) Test_Scale_InspectError() {
...
func (s *NodeScalerNewTestSuite) Test_Scale_CloudGetNodesError() {
...
func (s *NodeScalerNewTestSuite) Test_Scale_CloudSetNodesError() {
...
func (s *NodeScalerNewTestSuite) Test_ScaleDown_ByFromQuery_LowerBoundFromService() {
...
func (s *NodeScalerNewTestSuite) Test_ScaleDown_ByFromQuery_LowerBoundFromDefault() {
...
func (s *NodeScalerNewTestSuite) Test_ScaleDown_ByFromQuery_UpperBoundFromService() {
	nodeType := cloud.NodeWorkerType
...
func (s *NodeScalerNewTestSuite) Test_ScaleDown_ByFromQuery_UpperBoundFromDefault() {
	nodeType := cloud.NodeManagerType
...
func (s *NodeScalerNewTestSuite) Test_ScaleUp_ByFromQuery() {
	nodeType := cloud.NodeWorkerType
...
func (s *NodeScalerNewTestSuite) Test_ScaleUp_ByFromService() {
	nodeType := cloud.NodeManagerType
...
func (s *NodeScalerNewTestSuite) Test_ScaleUp_ByFromDefault() {
	nodeType := cloud.NodeWorkerType
...
func (s *NodeScalerNewTestSuite) Test_ScaleDown_ByFromQuery() {
...
func (s *NodeScalerNewTestSuite) Test_ScaleDown_ByFromService() {
...
func (s *NodeScalerNewTestSuite) Test_ScaleDown_ByFromDefault() {
